...
export const ColorChooser = ({ handleColorPick }) => {
  ...
  const handleClick = (color) => {
    ...
    if (color === "yellow") {
      document.body.style.background = "linear-gradient(90deg, rgba(217,198,112,1) 0%, rgba(255,223,0,1) 41%, rgba(204,185,99,1) 100%)";
    } else if (color === "white") {
      document.body.style.background = "linear-gradient(90deg, rgb(80, 80, 80) 0%, rgb(40, 40, 40) 41%, rgb(80, 80, 80) 100%)";
    }
  }
